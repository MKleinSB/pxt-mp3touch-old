...
// line 53,59 serial.readbuffer line 306 serial.writebuffer
...
namespace makerbit {
     ...
     */
    //% blockId="makerbit_mp3_connect" block="verbinde MP3 Gerät mit MP3 RX an %mp3RX | und MP3 TX an %mp3TX"
     ...
     */
    //% blockId="makerbit_mp3_play_track_from_folder" block="spiele MP3 Titel %track | im Ordner %folder | %repeat"
     ...
     */
    //% blockId="makerbit_mp3_play_folder" block="spiele MP3 Ordner %folder | %repeat"
    //% folder.min=1 folder.max=99
    //% weight=47
     ...
     */
    //% blockId="makerbit_mp3_set_volume" block="stelle MP3 Lautstärke auf %volume"
    ...
    //% block="starte MP3 Kommando %command"
    //% weight=45
